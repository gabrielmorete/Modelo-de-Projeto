...
% Para referências estilo ABNT tire o comentário de uma das linhas abaixo 
% e comente a linha '\bibliographystyle{plain}' logo abaixo.
...
\AtEndDocument{
    ...
    \bibliographystyle{plain} % Estilo da bibliografia: www.openoffice.org/bibliographic/bibtex-defs.html
    % Comente a linha acima se estiver usando padrão ABNT
}
